;(function(undefined) {
   ...
   */
  sigma.canvas.edges.labels.modelling =
    function(edge, source, target, context, settings) {
    if (typeof edge.label !== 'string' || source == target)
      return;

    var prefix = 'cam0:',//settings('prefix') || '',
    ...
    source = sigma.utils.calcCamNode(source, prefix);
    target = sigma.utils.calcCamNode(target, prefix);
