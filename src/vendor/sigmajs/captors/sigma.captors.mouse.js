;(function(undefined) {
  ...
  sigma.captors.mouse = function(target, camera, settings) {
    ...
    document.addEventListener('mousemove', _moveHandler, false);
    document.addEventListener('mousedown', _downHandler, false);
    document.addEventListener('click', _clickHandler, false);
    document.addEventListener('mouseout', _outHandler, false);
