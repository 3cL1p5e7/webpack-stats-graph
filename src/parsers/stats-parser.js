export const load = function load(stats) {
  ...
  var result = {};
	result.stats = stats;
	result.mapChunks = mapChunks;
	result.mapModules = mapModules;
	result.mapModulesUid = mapModulesUid;
  result.mapModulesIdent = mapModulesIdent;
  return result;
}
